(function() {
    ...
    var html = '<form method="post" action="https://dc-widget-app.herokuapp.com/api/posts" class="daves-widget-form"><div class="daves-widget-form-content"><p class="daves-widget-form-title" > App Form </p><input class="daves-widget-form-message" name="post[name]" type="text" placeholder="your name"><input class="daves-widget-form-message" name="post[content]" type="text" placeholder="your post"><button class="daves-widget-form-submit">Submit</button></div></form>';

(function() {
    ...
    <form method="post" class="daves-widget-form">\
      <div class="daves-widget-form-content">\
        ...
        <input class="daves-widget-form-message" name="post[content]" type="text" placeholder="your post">\
    ...
    if (typeof dcWidget_formBackgroundColor !== 'undefined' ) {
      var color = dcWidget_formBackgroundColor || 'white'
      css = css + '.daves-widget-form{background-color:' + color + ';}'
    }
